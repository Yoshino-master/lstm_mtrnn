...
def rnn(io_size, fast_hidden_size, slow_hidden_size):
    model = chainer.Chain(x_to_fh=L.Linear(io_size, fast_hidden_size),
...
#     model = chainer.ChainList(L.Linear(io_size, fast_hidden_size),
#                             L.Linear(fast_hidden_size, fast_hidden_size),
#                             L.Linear(fast_hidden_size, slow_hidden_size),
#                             L.Linear(slow_hidden_size, fast_hidden_size),
#                             L.Linear(slow_hidden_size, slow_hidden_size),
#                             L.Linear(fast_hidden_size, io_size))
...
#         optimizer.weight_decay(args.weightdecay)
    ...
    with open('train.txt','a+') as f:
        f.write( '%s %s %s' %(epoch, error, now-cur) + '\n' )
...
pickle.dump(model.to_cpu(),open('mnistMTRNN_model','wb'))
pickle.dump(Csc0_train,open('Csc0_train','wb')) 
pickle.dump(Csc0_test,open('Csc0_test','wb'))
